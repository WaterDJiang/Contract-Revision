...
export const processUserRequest = async (
  ...
  const prompt = `
    ...
    2. If ANALYSIS (e.g. "What are the risks?", "Explain this clause"):
       ...
       - highlights: An array of EXACT substrings from the "Current Contract" that are relevant to your answer (e.g. risky clauses). These will be highlighted for the user.
