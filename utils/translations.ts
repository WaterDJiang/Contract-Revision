...
export const translations = {
  en: {
    landing: {
      ...
      title: "Next-Gen Contract Drafting & Review",
      subtitle: "Say goodbye to unreadable legalese and repetitive paperwork. AI helps non-lawyers spot contract pitfalls and helps professionals quickly generate standard clauses—so everyone can handle contracts efficiently.",
      btnNew: "Generate Contract Template",
      btnImport: "Review Existing Contract",
      btnCompare: "Compare Old vs New",
  ...
  zh: {
    landing: {
      badge: "AI 驱动的法律工作台",
      title: "新一代合同起草&审核工具",
      subtitle: "告别看不懂的法律条文和重复的文档工作，AI帮法律小白识别合同陷阱，助专业律师快速生成标准条款，让每个人都能高效处理合同。",
      btnNew: "生成合同模板",
      btnImport: "审核已有合同",
      btnCompare: "对比新旧合同",
      footer: "© 2025 Wattter Lex. 由 Google Gemini 提供支持。",
    ...
    chat: {
      ...
      inputPlaceholder: "描述需求（例如：'帮我生成一份贸易合同'）...",
